...
class Admin extends CI_Controller
{
    ...
    public function profilepage()
    {
      ...
      if ($profile_isset == false) {
        ...
        $this->load->view('admin/profilepage',$data);
        $this->load->view('admin/footer');
      } else {
    ...
    public function dash()
    {
        ...
        var_dump($data);
        $this->load->view('admin/header',$data);
        $this->load->view('admin/dash',$data); // page for dashboard
        $this->load->view('admin/footer');
    }
    public function dash2()
    {
        ...
        $data['mission'] = $this->clientmodel->viewallmision();
        $this->load->view('admin/header',$data);
        $this->load->view('admin/dash2',$data); // page for dashboard
        $this->load->view('admin/footer');
    }
    ...
    public function addprofile()
    {
        ...
        if ($this->form_validation->run() === false) {
            $this->load->view('admin/header');
            $this->load->view('admin/'); //page to show profile
            $this->load->view('admin/footer');
        } else {
            $this->load->view('admin/header');
            $this->load->view('admin/'); //page to view profile
            $this->load->view('admin/footer');
        }
    }
    public function treated()
    {
      ...
      $user_id = $user->id;
      $data['user'] = $user;
      $treat = $this->clientmodel->treat($req_id);
      $data['mission'] = $this->clientmodel->viewallmision();
      $this->load->view('admin/header', $data);
      $this->load->view('admin/dash', $data); //page to show profile
      $this->load->view('admin/footer');

    }
    public function nottreated()
    {
      $req_id = $this->uri->segment(3);
      $user = $this->ion_auth->user()->row();
      $user_id = $user->id;
      $data['user'] = $user;
      $treat = $this->clientmodel->nottreat($req_id);
      $data['mission'] = $this->clientmodel->viewallmision();
      $this->load->view('admin/header', $data);
      $this->load->view('admin/dash', $data); //page to show profile
      $this->load->view('admin/footer');
    ...
    public function makereq()
    {
      ...
      $data['user'] = $user;
      $this->load->view('admin/header', $data);
      $this->load->view('admin/makereq', $data); //page to view profile
      $this->load->view('admin/footer');
    }
    ...
    public function makerequest()
    {
      ...
      if ($this->form_validation->run() === false) {
          $this->load->view('admin/header', $data);
          $this->load->view('admin/makereq' ,$data); //page to show profile
          $this->load->view('admin/footer');
      } else {
    ...
    public function editrequest()
    {
      ...
      $this->load->view('admin/header', $data);
      $this->load->view('admin/', $data); //page to show profile
      $this->load->view('admin/footer');
    }
    ...
    public function deleterequest()
    {
      ...
      if ($delmission == TRUE) {
        ...
        $this->load->view('admin/header', $data);
        $this->load->view('admin/viewreq', $data); //page to show profile
        $this->load->view('admin/footer');
      } else {
    ...
    public function onerequest()
    {
      ...
      // var_dump($data);
      $this->load->view('admin/header', $data);
      $this->load->view('admin/viewonereq', $data); //page to show profile
      $this->load->view('admin/footer');
    }
